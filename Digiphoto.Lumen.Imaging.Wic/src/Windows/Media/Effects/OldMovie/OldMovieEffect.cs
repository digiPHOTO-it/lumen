...
namespace Digiphoto.Lumen.Windows.Media.Effects {
	...
	public class OldMovieEffect : ShaderEffectBase {
		...
		public OldMovieEffect() : base() {
	
/*
			PixelShader pixelShader = new PixelShader();
			pixelShader.UriSource = new Uri("/Shazzam.Shaders;component/OldMovieEffect.ps", UriKind.Relative);
