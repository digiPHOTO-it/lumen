	...
	class MainWindowViewModel : ClosableWiewModel {
		...
		private void reportVendite() {
			...
			if( esito == true ) {
				...
				string appo = String.IsNullOrEmpty( UserConfigLumen.DescrizionePuntoVendita ) ? "pdv " + UserConfigLumen.CodicePuntoVendita : UserConfigLumen.DescrizionePuntoVendita;
