...
OutputBaseFilename=setup-{#MyAppName}-{#MyAppVersion}-x86
...
Source: "..\Digiphoto.Lumen.GestoreConfigurazione.UI\{#dirPlat}\Images\*"; DestDir: "{app}\Images"; Flags: ignoreversion 
